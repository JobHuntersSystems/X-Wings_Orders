...
{
    // 1. Heredamos de FormsDesigner.frmBase en lugar de Form
    public partial class Form1 : FormsDesigner.frmBase
    {
        ...
        // 2. Modificamos el constructor para recibir el nombre de la tabla
        public Form1(string tableName)
        {
            InitializeComponent();
            base._tableName = tableName; // Se lo pasamos al padre
        ...
        private void loadData()
        {
            ...
            dgvBase.DataSource = bs_categories; // Usamos el dgvBase heredado
        }

        private void bindControls()
        {
            // Nota: Si tus TextBox están dentro de un panel, cambia 'this.Controls' por 'pnlData.Controls'
        ...
        #region Events
        // 3. Sobrescribimos el método virtual del padre para borrar filas
        ...
        private void FormsCategory_Load(object sender, EventArgs e)
        {
            isNew = false;
            try
            {
        ...
        private void logsTimer_Tick(object sender, EventArgs e)
        {
            ...
            logsTimer.Dispose(); // Nota: Ojo con el Dispose si planeas reusar el timer. Quizás solo Stop() sea suficiente.
        }
        #endregion
    }
}